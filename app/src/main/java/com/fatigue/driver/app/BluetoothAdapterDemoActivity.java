...
public class BluetoothAdapterDemoActivity extends FragmentActivity {
    ...
    private TextView tv_lowalpha,tv_highalpha;
    private TextView tv_lowbeta,tv_highbeta;
    private TextView tv_lowgamma,tv_middlegamma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.initView();
        this.initDrawWaveView();
        this.initNskAlgoSdk();

        LinkDetectedHandler = this.initLinkDetectedHandler();
        callback = this.initCallback(); //jsnieves:COMMENT:TgStreamHandler object
...
//				return;
    ...
    //jsnieves:COMMENT:instantiate Log files and parent directory in phone's non-volatile, internal memory
