package com.fatigue.driver.app; /*
 |  CREATED on 10/10/16.
 |
 |  jsnieves:COMMENT:testing class (copy of DrawWaveView)
 |
 |
*/
...
//jsnieves:COMMENT:class copied from package com.neurosky.mindwavemobiledemo; (TGStreamDemo_MindWaveMobile)
// /home/systems/nieves/AndroidStudioProjects/Samples/TGStreamDemo_MindWaveMobile

public class DrawMultiWaveView extends View {
    private static final String TAG = "DrawWaveView";
    public Paint paint = null;
    int VIEW_WIDTH = 0;                 //jsnieves:COMMENT:unused
    int VIEW_HEIGHT = 0;                //jsnieves:COMMENT:unused
    ...
    private boolean restart = true;     //jsnieves:COMMENT:unused
    ...
    public DrawMultiWaveView(Context context) {
        super(context);
    }

    public DrawMultiWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//		Log.d(TAG,"initView  mPixPerHeight= "+ mPixPerHeight +" ,mPixPerWidth=" +mPixPerWidth);
    ...
    public boolean isReady() {  //jsnieves:COMMENT:unused
        return initFlag;
    }

    public void updateData(int data) {
        //jsnieves:COMMENT:this method updates the graph
